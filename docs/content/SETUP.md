...
### Q: 怎么更新？
A: 用 git clone 的：`cd ~/Documents/gongji-wiki && git pull`。下载 ZIP 的：重新下载覆盖。
...
1. 搜索错误信息 — 大概率有人遇到过
2. GitHub Issues：https://github.com/<user>/gongji-wiki/issues
