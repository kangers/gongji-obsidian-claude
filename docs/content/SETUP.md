...
2. 选中 `gongji-obsidian-claude` 文件夹 → Open
...
打开终端粘贴：
```bash
cd ~/Documents/gongji-obsidian-claude
...
### 查询知识
```
请用 [宪法](wiki/概念/宪法) 中的内容，解释"宪法是国家的根本法"。
```
...
### Q: 怎么更新？
A: 用 git clone 的：`cd ~/Documents/gongji-obsidian-claude && git pull`。下载 ZIP 的：重新下载覆盖。
...
1. 搜索错误信息 — 大概率有人遇到过
2. GitHub Issues：https://github.com/kangers/gongji-obsidian-claude/issues
