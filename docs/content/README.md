...
### 🅰️ 只想在线浏览？
→ 直接访问文档站：**https://<user>.github.io/gongji-wiki**
...
```
然后用 Obsidian 打开 `gongji-wiki` 文件夹即可。所有 wiki-link 直接可用。
...
详见 [LLM Wiki](LLM Wiki)(LLM Wiki.md) 和 [LLM-WORKFLOW](LLM-WORKFLOW)(LLM-WORKFLOW.md)。
...
- 🐛 报告内容错误 → [提 Issue](https://github.com/<user>/gongji-wiki/issues/new?template=内容贡献.md)
- 📝 新增考点或题目 → [Pull Request](CONTRIBUTING.md)
- 💡 提出改进建议 → [Discussions](https://github.com/<user>/gongji-wiki/discussions)
